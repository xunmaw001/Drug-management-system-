<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="报损时间" prop="baosunshijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.baosunshijian" 
                type="datetime"
                placeholder="报损时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.baosunshijian" label="报损时间" prop="baosunshijian">
              <el-input v-model="ruleForm.baosunshijian" 
                placeholder="报损时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="报损数量" prop="baosunshuliang">
          <el-input v-model="ruleForm.baosunshuliang" 
              placeholder="报损数量" clearable  :readonly="ro.baosunshuliang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="报损数量" prop="baosunshuliang">
              <el-input v-model="ruleForm.baosunshuliang" 
                placeholder="报损数量" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="原因说明" prop="yuanyinshuoming">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="原因说明"
                  v-model="ruleForm.yuanyinshuoming" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.yuanyinshuoming" label="原因说明" prop="yuanyinshuoming">
                    <span>{{ruleForm.yuanyinshuoming}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	pinpai : false,
	baosunshijian : false,
	baosunshuliang : false,
	yuanyinshuoming : false,
      },
      ruleForm: {
        gonghao: '',
        xingming: '',
  ...
  created() {
	this.ruleForm.baosunshijian = this.getCurDateTime()
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.pinpai = true;
          ...
          if(o=='baosunshijian'){
            this.ruleForm.baosunshijian = obj[o];
	    this.ro.baosunshijian = true;
            continue;
          }
          if(o=='baosunshuliang'){
            this.ruleForm.baosunshuliang = obj[o];
	    this.ro.baosunshuliang = true;
            continue;
          }
          if(o=='yuanyinshuoming'){
            this.ruleForm.yuanyinshuoming = obj[o];
	    this.ro.yuanyinshuoming = true;
            continue;
          }
        }
      }
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `baosunshenbao/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.baosunshenbaoCrossAddOrUpdateFlag = false;
                  this.parent.search();
