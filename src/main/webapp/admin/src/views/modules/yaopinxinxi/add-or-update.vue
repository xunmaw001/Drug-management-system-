<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="过期时间" prop="guoqishijian">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.guoqishijian" 
                type="date"
                placeholder="过期时间">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.guoqishijian" label="过期时间" prop="guoqishijian">
              <el-input v-model="ruleForm.guoqishijian" 
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jiage = true;
          ...
          if(o=='guoqishijian'){
            this.ruleForm.guoqishijian = obj[o];
	    this.ro.guoqishijian = true;
            continue;
          }
          if(o=='tupian'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.$http({
              url: `option/yaopinfenlei/leibie`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
