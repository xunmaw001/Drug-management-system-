    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="销售说明" prop="xiaoshoushuoming">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="销售说明"
                  v-model="ruleForm.xiaoshoushuoming" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.xiaoshoushuoming" label="销售说明" prop="xiaoshoushuoming">
                    <span>{{ruleForm.xiaoshoushuoming}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zongjia = true;
          ...
          if(o=='xiaoshoushuoming'){
            this.ruleForm.xiaoshoushuoming = obj[o];
	    this.ro.xiaoshoushuoming = true;
            continue;
          }
        }
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `xiaoshoujilu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.xiaoshoujiluCrossAddOrUpdateFlag = false;
                  this.parent.search();
