...
public class YaopinfenleiController {
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,YaopinfenleiEntity yaopinfenlei, HttpServletRequest request){
        EntityWrapper<YaopinfenleiEntity> ew = new EntityWrapper<YaopinfenleiEntity>();
		PageUtils page = yaopinfenleiService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, yaopinfenlei), params), params));
        return R.ok().put("data", page);
    }
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<YaopinfenleiEntity> wrapper = new EntityWrapper<YaopinfenleiEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = yaopinfenleiService.selectCount(wrapper);
